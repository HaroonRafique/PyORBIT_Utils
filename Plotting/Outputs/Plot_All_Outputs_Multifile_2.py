...
dd = dict()
dd = add_input_file(dd, './Vertical_Scan/24/output/output.mat', '6.24')
dd = add_input_file(dd, './Vertical_Scan/22/output/output.mat', '6.22')
dd = add_input_file(dd, './Vertical_Scan/20/output/output.mat', '6.20')
dd = add_input_file(dd, './Vertical_Scan/18/output/output.mat', '6.18')
dd = add_input_file(dd, './Vertical_Scan/16/output/output.mat', '6.16')
dd = add_input_file(dd, './Vertical_Scan/14/output/output.mat', '6.14')
dd = add_input_file(dd, './Vertical_Scan/12/output/output.mat', '6.12')
dd = add_input_file(dd, './Vertical_Scan/10/output/output.mat', '6.10')
...
plot_parameter(dd, parameter = 'epsn_x', filename = main_label, percentage = False, turns = turn_tot, legend_label = legend_label)
