...
def generate_initial_distribution_from_tomo_offset(parameters, matfile=0, Lattice=None, output_file='ParticleDistribution.in', outputFormat='pyOrbit', summary_file='ParticleDistribution_summary.txt', summary_mat_file=None):
	...
	# Instantiate the classes for longitudinal and transverse distns
	...
	z = (t_rand * 1e-9) * speed_of_light * parameters['beta'] + parameters['circumference'] * parameters['phase_offset'] / (2 * np.pi) # convert ns to s and then m, add offset
