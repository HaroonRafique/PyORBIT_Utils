...
# ~ print particles_in['particles']['ParticleIdNumber']
...
particles = len(particles_in['particles']['x'][0][0][0])
nums=range(0,particles-1)

# ~ print colors

for i in nums:
        print colors[sorted_names[i]]

# ~ sys.exit();

# ~ for i in nums:
        # ~ ax1.scatter(particles_out['particles']['x'][0][0][0][i], particles_out['particles']['y'][0][0][0][i], color=colors[sorted_names[i]], label='1.6 eVs');
...
for i in nums:
        ax3.scatter(particles_out['particles']['x'][0][0][0][i], particles_out['particles']['xp'][0][0][0][i], color=colors[sorted_names[i]], label='1.6 eVs');
