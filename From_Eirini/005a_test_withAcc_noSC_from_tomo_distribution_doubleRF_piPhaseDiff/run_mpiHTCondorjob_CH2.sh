...
export ORBIT_ROOT=/afs/cern.ch/work/e/eirini2/private/pyorbit_env/py-orbit

source /afs/cern.ch/work/e/eirini2/private/pyorbit_env/py-orbit/customEnvironment.sh
echo "customEnvironment done"
source /afs/cern.ch/work/e/eirini2/private/pyorbit_env/virtualenvs/py2.7/bin/activate
...
tstart=$(date +%s)
nnodes=$1
mpirun -np $nnodes ${ORBIT_ROOT}/bin/pyORBIT pyOrbit.py > "${output_dir}/dumptest.txt"
tend=$(date +%s)
dt=$(($tend - $tstart))
