...
# Open File
loss_file_1='runtimes_PS_2p5d_SC_64_64_20.txt'
label1 = '64x64x20'
turns1 = 10

fin1=open(loss_file_1,'r').readlines()[1:]
...
# Open File
loss_file2='runtimes_PS_2p5d_SC_32_32_32.txt'
label2 = '32x32x32'
turns2 = 100
...
(sec1, sec2) = equate_turns(sec1, sec2, turns1, turns2)

print '\nsec1 = ', sec1;
print '\nsec2 = ', sec2;
(spernode1, spernode2) = equate_turns(spernode1, spernode2, turns1, turns2)
(sperthread1, sperthread2) = equate_turns(sperthread1, sperthread2, turns1, turns2)
(sperturn1, sperturn2) = equate_turns(sperturn1, sperturn2, turns1, turns2)
