...
dd = add_input_file(dd, './32/output/output.mat', '32x32x16_SbS')
dd = add_input_file(dd, './64/output/output.mat', '64x64x32_SbS')
dd = add_input_file(dd, './128/output/output.mat', '128x128x64_SbS')
dd = add_input_file(dd, './256/output/output.mat', '256x256x128_SbS')
