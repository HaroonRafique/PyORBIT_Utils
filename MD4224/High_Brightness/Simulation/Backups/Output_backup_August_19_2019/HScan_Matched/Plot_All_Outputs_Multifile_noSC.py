...
dd = dict()
dd = add_input_file(dd, './621_noSC/output/output.mat', '6.21')
dd = add_input_file(dd, './619_noSC/output/output.mat', '6.19')
dd = add_input_file(dd, './617_noSC/output/output.mat', '6.17')
dd = add_input_file(dd, './615_noSC/output/output.mat', '6.15')
dd = add_input_file(dd, './613_noSC/output/output.mat', '6.13')
dd = add_input_file(dd, './611_noSC/output/output.mat', '6.11')
dd = add_input_file(dd, './609_noSC/output/output.mat', '6.09')
dd = add_input_file(dd, './607_noSC/output/output.mat', '6.07')
