...
# READ OUTPUT
input_file1 = 'output.mat'
particles1 = dict()
sio.loadmat(input_file1, mdict=particles1)

input_file2 = '../../2_Node/output/output.mat'
particles2 = dict()
sio.loadmat(input_file2, mdict=particles2)

input_file3 = '../../3_Node/output/output.mat'
particles3 = dict()
sio.loadmat(input_file3, mdict=particles3)

input_file4 = '../../4_Node/output/output.mat'
particles4 = dict()
sio.loadmat(input_file4, mdict=particles4)

# ~ input_file5 = '../../5_Node/output/output.mat'
# ~ particles5 = dict()
# ~ sio.loadmat(input_file5, mdict=particles5)
...
ax1.plot(particles1['turn'][0], particles1['turn_duration'][0], 'c', label='1 Node');
ax1.plot(particles2['turn'][0], particles2['turn_duration'][0], 'r', label='2 Node');
ax1.plot(particles3['turn'][0], particles3['turn_duration'][0], 'm', label='3 Node');
ax1.plot(particles4['turn'][0], particles4['turn_duration'][0], 'b', label='4 Node');
# ~ ax1.plot(particles5['turn'][0], particles5['turn_duration'][0], 'g', label='5 Node');
ax1.set_xlabel('Turn [-]');
...
# Turn vs turn_duration per node
# ~ ax2 = fig1.add_subplot(312)
# ~ ax2.plot(particles1['turn'][0], particles1['cumulative_time'][0], 'c', label='1 Node');
# ~ ax2.plot(particles2['turn'][0], (particles2['cumulative_time'][0]/2), 'r', label='2 Node');
# ~ ax2.plot(particles3['turn'][0], (particles3['cumulative_time'][0]/3), 'm', label='3 Node');
# ~ ax2.plot(particles4['turn'][0], (particles4['cumulative_time'][0]/4), 'b', label='4 Node');
# ~ ax2.plot(particles5['turn'][0], (particles5['cumulative_time'][0]/5), 'g', label='5 Node');
# ~ ax2.set_xlabel('Turn [-]');
...
ax3.plot(particles1['turn'][0], particles1['cumulative_time'][0], 'c', label='1 Node');
ax3.plot(particles2['turn'][0], particles2['cumulative_time'][0], 'r', label='2 Node');
ax3.plot(particles3['turn'][0], particles3['cumulative_time'][0], 'm', label='3 Node');
ax3.plot(particles4['turn'][0], particles4['cumulative_time'][0], 'b', label='4 Node');
# ~ ax2.plot(particles5['turn'][0], particles5['cumulative_time'][0], 'g', label='5 Node');
ax3.set_xlabel('Turn [-]');
ax3.set_ylabel('Cumulative time [s]');
ax3.set_title('PS Injection HPC-Batch test: N = 5E3, 16x16x16, cumulative time');
ax3.grid(True);
ax3.legend()


fig1.savefig('Cumulative_and_Turn_Time_cf.png');
