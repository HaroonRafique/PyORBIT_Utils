...
output_file  = open('xytune.dat', 'w')
output_file.write('#Turn\tx\ty')

sorted_iterators = sorted(iterators)
print sorted_iterators

for i in sorted_iterators:
    output_file.write(i,'\t',d[i]['particles']['x'][0][0][0], '\t', d[i]['particles']['y'][0][0][0])
