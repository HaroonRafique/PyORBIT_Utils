...
# This doesn't work: readScriptPTC('input/RF_table.ptc')
...
# ~ print 'length = ', paramsDict["length"]
# ~ print 'kin_Energy = ', kin_Energy
# ~ print 'n_macroparticles = ', p['n_macroparticles'] + 1
...
#-----------------------------------------------------
print '\nTune analysis on MPI process: ', rank
