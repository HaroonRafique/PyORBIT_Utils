...
dd = dict()
dd = add_input_file(dd, './624_noSC/output/output.mat', '6.21')
dd = add_input_file(dd, './622_noSC/output/output.mat', '6.19')
dd = add_input_file(dd, './620_noSC/output/output.mat', '6.17')
dd = add_input_file(dd, './618_noSC/output/output.mat', '6.15')
dd = add_input_file(dd, './616_noSC/output/output.mat', '6.13')
dd = add_input_file(dd, './614_noSC/output/output.mat', '6.11')
dd = add_input_file(dd, './612_noSC/output/output.mat', '6.09')
dd = add_input_file(dd, './610_noSC/output/output.mat', '6.07')
