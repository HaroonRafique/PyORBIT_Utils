...
#~ subprocess.call(["/hpcscratch/user/harafiqu/PyORBIT/virtualenvs/py2.7/bin/activate"])
#~ subprocess.call(["source", "/cvmfs/projects.cern.ch/intelsw/psxe/linux/all-setup.sh"])
#~ subprocess.call(["source", "/hpcscratch/user/harafiqu/PyORBIT/py-orbit/customEnvironment.sh"])

import math
import sys
#~ sys.path.insert(0, './hpcscratch/user/harafiqu/PyORBIT/virtualenvs/py2.7/lib/python2.7/site-packages')
import time
import orbit_mpi
import timeit
import os
...
import numpy as np
#~ import /hpcscratch/user/harafiqu/PyORBIT/virtualenvs/py2.7/lib/python2.7/site-packages/scipy.io as sio
#~ import /hpcscratch/user/harafiqu/PyORBIT/virtualenvs/py2.7/lib/python2.7/site-packages/numpy as np
