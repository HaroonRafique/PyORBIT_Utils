...
def tomo_distn_dispersion_mismatch(parameters, mismatch=1.3, matfile=0, Lattice=None, output_file='ParticleDistribution.in', outputFormat='pyOrbit', summary_file='ParticleDistribution_summary.txt', summary_mat_file=None):
	...
	if orbit_mpi.MPI_Comm_rank(comm) == 0:
		...
		with open(output_file,"w") as fid:
			...
			for i in range(parameters['n_macroparticles']):
				...
				print '\n dpp = ', dpp
				x[i] += dpp * dispersionx['etax0'] * mismatch
				xp[i] += dpp * dispersionx['etapx0'] * mismatch	
				y[i] += dpp * dispersiony['etay0'] * mismatch
				yp[i] += dpp * dispersiony['etapy0'] * mismatch	
