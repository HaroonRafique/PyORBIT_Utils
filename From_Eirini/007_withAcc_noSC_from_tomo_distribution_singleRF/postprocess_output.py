...
txtfile = np.loadtxt('output/mainbunch_000999', skiprows=17, usecols=(0,1,2,3,4,5))
#txtfile = np.loadtxt('output/mainbunch_5.dat', skiprows=17, usecols=(0,1,2,3,4,5))
x = txtfile[:,0]
xp = txtfile[:,1]
y = txtfile[:,2]
yp = txtfile[:,3]
...
ax1.set_title('After tracking 1000 turns')
...
plt.savefig('phasespace_after1000turns.png')
#plt.show()
