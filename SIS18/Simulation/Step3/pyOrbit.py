...
if horizontal:
        Particle_distribution_file = generate_initial_poincare_distributionH(3.3, p, Lattice, output_file='input/ParticleDistribution.in', summary_file='input/ParticleDistribution_summary.txt')
else:
