...
epsn_x = 2.26e-6 
epsn_y = 2.134e-6 
blength_rms = (0.91*299792458*210e-9)/4.	# 14.32 m
dpp_rms = 1.31e-03
# ~ rf_voltage=0.0365e6
rf_voltage = 0.0304388132103E6
...
Ekin_GeV = 1.4*ones
# ~ RF_voltage_MV = np.array([0.0365*ones]).T # in MV
RF_voltage_MV = np.array([0.0304388132103*ones]).T # in MV
