...
dd = dict()
dd = add_input_file(dd, './624_noSC/output/output.mat', '6.24')
dd = add_input_file(dd, './622_noSC/output/output.mat', '6.22')
dd = add_input_file(dd, './620_noSC/output/output.mat', '6.20')
dd = add_input_file(dd, './618_noSC/output/output.mat', '6.18')
dd = add_input_file(dd, './616_noSC/output/output.mat', '6.16')
dd = add_input_file(dd, './614_noSC/output/output.mat', '6.14')
dd = add_input_file(dd, './612_noSC/output/output.mat', '6.12')
dd = add_input_file(dd, './610_noSC/output/output.mat', '6.10')

print 'Final data dictionary keys: ', sorted(dd.keys())
		
sc = 'noSC'
main_label = 'V_Scan_Fixed_Initial_Distn'
