...
# Analyse stored bunch method
#-----------------------------------------------------------------------		
		if s['Analysed']:
			# Load distn for Twiss analysis
			bunch_in = Bunch()
			bunch_in = bunch_from_matfile(p['input_distn_dir'])
			bunchtwissanalysis_in = BunchTwissAnalysis()
			bunchtwissanalysis_in.analyzeBunch(bunch_in)
			
			twiss_dict['alpha_x'] 			= bunchtwissanalysis_in.getAlpha(0)
			twiss_dict['alpha_y'] 			= bunchtwissanalysis_in.getAlpha(1)
			twiss_dict['beta_x'] 			= bunchtwissanalysis_in.getBeta(0)
			twiss_dict['beta_y'] 			= bunchtwissanalysis_in.getBeta(1)
			twiss_dict['D_x'] 				= bunchtwissanalysis_in.getDispersion(0)
			twiss_dict['D_y'] 				= bunchtwissanalysis_in.getDispersion(1)
			twiss_dict['D_xp'] 				= bunchtwissanalysis_in.getDispersionDerivative(0)
			twiss_dict['D_yp'] 				= bunchtwissanalysis_in.getDispersionDerivative(1)
			twiss_dict['x0'] 				= 0.
			twiss_dict['xp0'] 				= 0.
			twiss_dict['y0'] 				= 0.
			twiss_dict['yp0'] 				= 0.
