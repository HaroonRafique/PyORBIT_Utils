...
for subdir, dirs, files in os.walk(rootdir):
    for file in files:
        ...
        if ext in extensions:
            ...
            print l.split((os.path.join(subdir, file)))[0]
            print l.split((os.path.join(subdir, file)))[1]
            print l.split((os.path.join(subdir, file)))[2]
            print l.split((os.path.join(subdir, file)))[3]
            print l.split((os.path.join(subdir, file)))[4]
sys.exit()
# Loop over each output folder
    intensity = 'I=1.9E11'
    step = '2'
    plane = 'x'
    extra = 'sc_pathlength_min_1E-4'
