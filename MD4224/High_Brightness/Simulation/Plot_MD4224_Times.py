...
dd = add_input_file(dd, './Vertical_Scan/610_SbS_nLK/output/output.mat', '10_n N=1 HT=1')
dd = add_input_file(dd, './Vertical_Scan/612_SbS_nLK/output/output.mat', '12_n N=1 HT=0')
dd = add_input_file(dd, './Vertical_Scan/614_SbS_nLK/output/output.mat', '14_n N=2 HT=1')
dd = add_input_file(dd, './Vertical_Scan/616_SbS_nLK/output/output.mat', '16_n N=2 HT=0')
dd = add_input_file(dd, './Vertical_Scan/618_SbS_nLK/output/output.mat', '18_n N=3 HT=1')
dd = add_input_file(dd, './Vertical_Scan/620_SbS_nLK/output/output.mat', '20_n N=3 HT=0')
dd = add_input_file(dd, './Vertical_Scan/622_SbS_nLK/output/output.mat', '22_n N=4 HT=1')
dd = add_input_file(dd, './Vertical_Scan/624_SbS_nLK/output/output.mat', '24_n N=4 HT=0')

dd = add_input_file(dd, './Vertical_Scan/610_SbS/output/output.mat', '10_S N=1 HT=1')
dd = add_input_file(dd, './Vertical_Scan/612_SbS/output/output.mat', '12_S N=1 HT=0')
dd = add_input_file(dd, './Vertical_Scan/614_SbS/output/output.mat', '14_S N=2 HT=1')
dd = add_input_file(dd, './Vertical_Scan/616_SbS/output/output.mat', '16_S N=2 HT=0')
dd = add_input_file(dd, './Vertical_Scan/618_SbS/output/output.mat', '18_S N=3 HT=1')
dd = add_input_file(dd, './Vertical_Scan/620_SbS/output/output.mat', '20_S N=3 HT=0')
dd = add_input_file(dd, './Vertical_Scan/622_SbS/output/output.mat', '22_S N=4 HT=1')
dd = add_input_file(dd, './Vertical_Scan/624_SbS/output/output.mat', '24_S N=4 HT=0')

dd = add_input_file(dd, './Vertical_Scan/610_2p5/output/output.mat', '10_2 N=1 HT=1')
dd = add_input_file(dd, './Vertical_Scan/612_2p5/output/output.mat', '12_2 N=1 HT=0')
dd = add_input_file(dd, './Vertical_Scan/614_2p5/output/output.mat', '14_2 N=2 HT=1')
dd = add_input_file(dd, './Vertical_Scan/616_2p5/output/output.mat', '16_2 N=2 HT=0')
dd = add_input_file(dd, './Vertical_Scan/618_2p5/output/output.mat', '18_2 N=3 HT=1')
dd = add_input_file(dd, './Vertical_Scan/620_2p5/output/output.mat', '20_2 N=3 HT=0')
dd = add_input_file(dd, './Vertical_Scan/622_2p5/output/output.mat', '22_2 N=4 HT=1')
dd = add_input_file(dd, './Vertical_Scan/624_2p5/output/output.mat', '24_2 N=4 HT=0')
