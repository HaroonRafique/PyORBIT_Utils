...
# ~ dd = add_input_file(dd, './N_mp_2p5/3E6/output/output.mat', '3E6_2.5D')
# ~ main_label = 'Convergence_N_mp_2p5'
# ~ main_label2 = 'Convergence_N_mp_2p5_zoom'

dd = add_input_file(dd, './N_mp_nLK/0p5E6/output/output.mat', '0.5E6_nLK')
dd = add_input_file(dd, './N_mp_nLK/1E6/output/output.mat', '1E6_nLK')
dd = add_input_file(dd, './N_mp_nLK/1p5E6/output/output.mat', '1.5E6_nLK')
