...
input_file_name='tomogram_R2_357.txt'
# ~ input_file_name='tomogram_R2_686.txt'
...
# ~ dt = float(regexp.findall(out[7])[0]) # ns
# ~ dE = float(regexp.findall(out[9])[0])  # MeV
...
# ~ tAxis -= 1	#MD4224 Vertical 1					# 1.3 eVs
# ~ EAxis += 0.8			
