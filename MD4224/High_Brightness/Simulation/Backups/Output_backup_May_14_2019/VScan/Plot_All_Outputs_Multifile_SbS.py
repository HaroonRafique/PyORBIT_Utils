...
def plot_emittance(sc, dd, filename, turns=[0,874,2185], ymin=None, ymax=None, tit = None, legend_label = None):
	...
	if legend_label is not None: 		
		ax1.legend(custom_lines, custom_labels, title=legend_label, frameon = False, fontsize='x-small')
	else:		
		ax1.legend(custom_lines, custom_labels, frameon = False, fontsize='x-small')
	...
	if legend_label is not None: 		
		ax2.legend(custom_lines, custom_labels, title=legend_label, frameon = False, fontsize='x-small')
	else:		
		ax2.legend(custom_lines, custom_labels, frameon = False, fontsize='x-small')
...
def plot_parameter(sc, dd, parameter, filename, percentage = False, ymin=None, ymax=None, ylab=None, yun = None, tit = None, multi=None, turns = None, legend_label = None, betagamma = None):
	...
	if legend_label is not None: 
		ax1.legend(title=legend_label, fontsize='x-small', loc=1)
	else:
...
def plot_effective_sigmas(sc, dd, filename, ymin=None, ymax=None, ylab=None, yun = None, tit = None, turns = None, legend_label = None, real = False, betagamma = None):
	...
	if legend_label is not None: 
		ax2.legend(title=legend_label, fontsize='x-small')
	else:
...
def plot_optics(sc, dd, filename):
	...
	ax1.legend(legend_elements2, ['Bunch Statistics', 'Effective Bunch Statistics', 'Linear Optics (No Space Charge)'], frameon=False, fontsize='x-small')
	ax1.set_xlabel(r'Q$_y$');
	...
	ax1.legend(legend_elements2, ['Bunch Statistics', 'Linear Optics (No Space Charge)'], frameon=False, fontsize='x-small')
	ax1.set_xlabel(r'Q$_y$');
	ax1.set_ylabel(r'$\beta_x$ [m]');
	tit = sc + ' ' + r'$\beta_x$'	
	ax1.set_title(tit);
...
dd = add_input_file(dd, './623_SbS/output/output.mat', '6.23')
...
sc = 'Slice-by-Slice LEQ'
main_label = 'Slice_By_Slice_LEQ'
