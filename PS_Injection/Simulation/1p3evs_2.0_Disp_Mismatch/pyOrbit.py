...
#-----------------------------------------------------------------------
	...
	if s['ImportFromTomo']:
		if '.mat' in p['tomo_file']:
			Particle_distribution = tomo_distn_dispersion_mismatch(p, p['dispersion_mismatch'],  1, Lattice, output_file='input/ParticleDistribution.in', summary_file='input/ParticleDistribution_summary.txt')
		else:
			Particle_distribution = tomo_distn_dispersion_mismatch(p, p['dispersion_mismatch'], 0, Lattice, output_file='input/ParticleDistribution.in', summary_file='input/ParticleDistribution_summary.txt')
	else:
