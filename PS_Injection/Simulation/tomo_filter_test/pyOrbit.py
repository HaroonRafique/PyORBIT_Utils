...
#-----------------------------------------------------------------------
	...
	if s['ImportFromTomo']:
		if '.mat' in p['tomo_file']:
			Particle_distribution = generate_initial_distribution_from_tomo_contour_check(p, 1, Lattice, output_file='input/ParticleDistribution.in', summary_file='input/ParticleDistribution_summary.txt')
			...
			Particle_distribution = generate_initial_distribution_from_tomo_contour_check(p, 0, Lattice, output_file='input/ParticleDistribution.in', summary_file='input/ParticleDistribution_summary.txt')
	else:
