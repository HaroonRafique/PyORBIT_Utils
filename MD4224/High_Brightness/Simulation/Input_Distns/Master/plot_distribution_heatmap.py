...
d={}                                # append empty turn to dictionary
sio.loadmat(infile, mdict=d)          # load the data from file  

print len(d['particles']['x'][0][0][0]), ' particles in bunch file'

# Find Max and Min values for plots
if max(d['particles']['x'][0][0][0]) > x_max : x_max = max(d['particles']['x'][0][0][0])            
if max(d['particles']['xp'][0][0][0]) > xp_max : xp_max = max(d['particles']['xp'][0][0][0])            
if max(d['particles']['y'][0][0][0]) > y_max : y_max = max(d['particles']['y'][0][0][0])            
if max(d['particles']['yp'][0][0][0]) > yp_max : yp_max = max(d['particles']['yp'][0][0][0])            
if max(d['particles']['z'][0][0][0]) > z_max : z_max = max(d['particles']['z'][0][0][0])            
if max(d['particles']['dE'][0][0][0]) > dE_max : dE_max = max(d['particles']['dE'][0][0][0])
if min(d['particles']['x'][0][0][0]) < x_min : x_min = min(d['particles']['x'][0][0][0])            
if min(d['particles']['xp'][0][0][0]) < xp_min : xp_min = min(d['particles']['xp'][0][0][0])            
if min(d['particles']['y'][0][0][0]) < y_min : y_min = min(d['particles']['y'][0][0][0])            
if min(d['particles']['yp'][0][0][0]) < yp_min : yp_min = min(d['particles']['yp'][0][0][0])            
if min(d['particles']['z'][0][0][0]) < z_min : z_min = min(d['particles']['z'][0][0][0])            
if min(d['particles']['dE'][0][0][0]) < dE_min : dE_min = min(d['particles']['dE'][0][0][0])

print d['particles']['ParticleIdNumber'][0][0][0]
